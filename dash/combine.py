...
h_b1=dcc.Dropdown(options=np.append(df_refined['Languages'].dropna().unique(),["NO CHOOSEN",]),
            value="NO CHOOSEN",
            placeholder="Select a Language",
            id="lang_dropdown",
            style={"width": "40%"}
        )
h_b2=dcc.Dropdown(options=np.append(df_refined['Districts'].dropna().unique(),["NO CHOOSEN",]),
            value="NO CHOOSEN",
...
# clientside_callback(
#     """
#     function(clickData,dataframe_dropdown){
...
#     const dff = df_lang[df_lang["Districts"] == district_name];
#     const fig = px.line(dff, x="Districts", y="Languages", markers=True);
#     return fig;
#     }
#     """,
...
def create_graph1(clickData,dataframe_dropdown,lang_dropdown,):
    ...
    #     df1 = df_refined[df_refined["Districts"] == district_dropdown]
    #     state_name=df1["STATE"]
    #     print(state_name)
